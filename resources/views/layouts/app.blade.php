                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto d-flex align-items-center">
                        ...
                        <li class="nav-item mr-3">
                            ...
                            <a href="{{ url('/producto/crear') }}" class="text-white" data-bs-toggle="tooltip"
                                data-bs-placement="bottom" title="Subir articulo"><svg
                        ...
                        <li class="nav-item mr-3">
                            ...
                            <a href="{{ url('/favoritos') }}" class="text-white" data-bs-toggle="tooltip"
                                data-bs-placement="bottom" title="Favoritos"> <svg xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="16" fill="currentColor" class="bi bi-heart-fill"
                                    viewBox="0 0 16 16">
